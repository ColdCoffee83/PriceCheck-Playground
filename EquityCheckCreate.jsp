...
<div class="row">
 ...
 <!-- Modal to select stakeholders for collaboration email -->
<div class="modal" tabindex="-1" role="dialog" id="stakeholdersModal">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Select Stakeholders for
                Collaboration Email</h5>
            ...
            <div class="modal-footer">
                <!-- Button to send collaboration email -->
                <button type="button" class="btn btn-primary"
                id="sendCollaborationEmailBtn">Send Collaboration
                Email</button>
